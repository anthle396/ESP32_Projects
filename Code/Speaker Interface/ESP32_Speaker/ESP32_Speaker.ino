...
// Define an enum for note frequencies
enum Note {
  C4 = 262, C4S = 277, D4 = 294, D4S = 311, E4 = 330,
  F4 = 349, F4S = 370, G4 = 392, G4S = 415, A4 = 440,
  A4S = 466, B4 = 494, C5 = 523, C5S = 554, D5 = 587,
  D5S = 622, E5 = 659, F5 = 698, F5S = 740, G5 = 784,
  NONE = 0
};
...
// Function to play "Happy Birthday"
void playHappyBirthday() {
  // Happy Birthday melody using the Note enum
  Note melody[] = {
    C4, NONE, C4, NONE, D4, NONE, D4, F4, E4, 
    NONE, C4, D4, C4, G4, F4, 
    C4, C4, C4, A4, F4, E4, 
